...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`Hotel room reservation application`}</title>

        <meta
          name="description"
          content="Hotel Room Reservation Application: Empowering Hotel Staff to Seamlessly Reserve Rooms for Future Dates with Ease and Efficiency"
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1590073844006-33379778ae09?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MXwxfHNlYXJjaHwxfHxob3RlbHxlbnwwfHx8fDE2OTU0NTMxNjN8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Hotel Room Reservation Application: Empowering Hotel Staff to Seamlessly Reserve Rooms for Future Dates with Ease and Efficiency`}
            </Text>
            <Box
            ...
            >
              <Stack direction={{ md: 'row', base: 'column' }} spacing="1.5rem">
                <Card userTypeName="Hotel Owner" type="hotel-owner" abilities={appConfig.ownerAbilities} />
              </Stack>
            </Box>
          </Box>
          <Box pt={4}>
