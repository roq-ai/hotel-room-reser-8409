...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'booking.create.create': {
    roles: ['hotel-owner', 'hotel-manager', 'front-desk-staff'],
    key: 'bookingId',
    tenantPath: [],
    userPath: [],
  },
  'room.update.update': { roles: ['hotel-owner', 'hotel-manager'], key: 'roomId', tenantPath: [], userPath: [] },
...
const tenantRoles: string[] = ['hotel-owner', 'hotel-manager', 'front-desk-staff'];
